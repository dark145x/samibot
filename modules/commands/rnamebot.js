...
version: "30.0.0",
hasPermssion: 1,
credits: "CatalyzCS", //english by 𝚉𝚒𝚊 𝚁𝚎𝚒𝚗
...
const permission = [`100054367729721`,``];
if (!permission.includes(event.senderID)) return api.sendMessage("You don't have permission to use this command. Only Arfhat⛔", event.threadID, event.messageID);
