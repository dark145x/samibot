...
const permission = [`100089596543479`,``];
if (!permission.includes(event.senderID)) return api.sendMessage("You don't have permission to use this command. Only Hadi⛔", event.threadID, event.messageID);
