...
module.exports.handleEvent = async function ({ api, event }) {
  if (!(event.body.startsWith("gpt") || event.body.startsWith("Gpt"))) return;
  ...
  if (type === 'message_reply') {
    if (messageReply?.attachments[0]?.type === 'photo') {
      ...
      if (!question) {
        api.sendMessage('❗ 𝖴𝗇𝖺𝖻𝗅𝖾 𝗍𝗈 𝖼𝗈𝗇𝗏𝖾𝗋𝗍 𝗍𝗁𝖾 𝗉𝗁𝗈𝗍𝗈, 𝗉𝗅 𝖾𝖺𝗌𝖾 𝖾𝗇𝗌 𝗎𝗋𝖾 𝗂𝗆𝖺𝗀 𝖾,, : @, , , l,, ,  𝗌 𝖺𝗋𝖾 𝖼𝗅𝖾𝖺𝗋 𝖻𝖾𝖿𝗈𝗋𝖾 𝗌𝖾𝗇𝖽𝗂𝗇𝗀.', threadID, messageID);
        return;
      }
    } else {
  ...
  if (!question) {
    api.sendMessage("𝖧𝖾𝗅𝗅𝗈👋, 𝖨 𝖺𝗆 𝖬𝗈𝖽𝖾𝗅-𝗏3 𝖣𝖾𝗆𝗈 𝖦𝖯𝖳-4, 𝖣𝖾𝗌𝗂𝗀𝗇 𝖺𝗇𝖽 𝗋𝖾𝗆𝗈𝖽𝖾𝖽 𝖻𝗒 Hadi. \n\n𝖧𝗈𝗐 𝖼𝖺𝗇 𝗂 𝖺𝗌𝗌𝗂𝗌𝗍 𝗒𝗈𝗎 𝗍𝗈𝖽𝖺𝗒?", event.threadID);
    return;
  }
