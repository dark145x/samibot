const fbname = "MrTomXxX";
const githubname = "MrTomXxX";
...
let a = await loadImage(pathAva)
    ...
    ctx.fillStyle = "#FFF"
    ctx.fillText("Arfhat", canvas.width /  2 - 660, 1600);
    ctx.save();
    ctx.font = "350px Grandstander";
    ctx.fillStyle = "#000"
    ctx.fillText("𝗦𝗮𝗸𝗶𝗯𝗶𝗻 𝗦𝗶𝗻𝗵𝗮", canvas.width / 2 - 660, 1000);
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("Islam", 1200, 2750);
    ctx.fillStyle = "#FFF"
    ctx.fillText("𝗦𝗮𝗸𝗶𝗯𝗶𝗻 𝗦𝗶𝗻𝗵𝗮", 1600, 3150);
    ctx.fillStyle = "#000"
   ctx.fillText("Xakibin", 2000, 3600);
    ctx.beginPath();
