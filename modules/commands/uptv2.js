...
let a = await loadImage(pathAva)
    ...
    ctx.fillStyle = "#FFF"
    ctx.fillText("Hadi", canvas.width /  2 - 660, 1600);
    ctx.save();
    ctx.font = "350px Grandstander";
    ctx.fillStyle = "#000"
    ctx.fillText("Hadi Muktadir", canvas.width / 2 - 660, 1000);
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("SINHA", 1200, 2750);
    ctx.fillStyle = "#FFF"
    ctx.fillText("Hadi Muktadir", 1600, 3150);
    ctx.fillStyle = "#000"
