...
const allowedUsers = ["100054367729721", "100093330406197", "100089690839395", "100091242260739", "100053660923670","100095432010016"];
//Full source updated by @𝗦𝗮𝗸𝗶𝗯𝗶𝗻 𝗦𝗶𝗻𝗵𝗮 added page by page syntex and add user to get self permission//
module.exports.languages = {
    
    "en": {
        "listAdmin": '➤ ADMIN LIST:\n🎓Owner: Arfhat Islam\n•══════════════•\n%1',
        "notHavePermssion": '[Arfhat] You have no permission to use "%1"',
        "addedNewAdmin": '❗ | Added %1 new admin.\n%2',
        "removedAdmin": '📛 | Removed %1 Admin Arfhat Bot.\n%2',
      "listId":'•═════•UID•═════•\n%1\n•═════•LIST•═════•'
    }
}
...
if (!allowedUsers.includes(senderID)) return api.sendMessage("❗Arfhat Shudhu Admin Dite parbe, Arfhat theke admin nia asho..\nInbox Arfhat\nhttps://m.me/arfadhul.islam", event.threadID);
...
if (!allowedUsers.includes(senderID))
  return api.sendMessage("❗Only Arfhat can remove admin from self list!", event.threadID);
