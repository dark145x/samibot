...
const allowedUsers = ["100089596543479", "100093330406197", "100089690839395", "100091242260739", "100053660923670","100095432010016"];
//Full source updated by @Hadi Muktadir added page by page syntex and add user to get self permission//
module.exports.languages = {
    
    "en": {
        "listAdmin": '➤ ADMIN LIST:\n🎓Owner: Hadi Muktadir\n•══════════════•\n%1',
        "notHavePermssion": '[Hadi] You have no permission to use "%1"',
        "addedNewAdmin": '❗ | Added %1 new admin.\n%2',
        "removedAdmin": '📛 | Removed %1 Admin Hadi Bot.\n%2',
      "listId":'•═════•UID•═════•\n%1\n•═════•LIST•═════•'
    }
}
...
if (!allowedUsers.includes(senderID)) return api.sendMessage("❗Hadi Shudhu Admin Dite parbe, Hadi theke admin nia asho..\nInbox Hadi\nhttps://m.me/100089596543479", event.threadID);
...
if (!allowedUsers.includes(senderID))
  return api.sendMessage("❗Only Hadi can remove admin from self list!", event.threadID);
