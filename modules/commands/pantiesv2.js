...
"https://konachan.net/image/efe6aa7bbeac98d05a98b31465b5fe65/Konachan.com%20-%20886%20ass%20close%20panties%20red%20skirt%20underwear%20upskirt.jpg?0.67499538349191",
	 ...
	 var callback = () => api.sendMessage({body:`𝚙𝚊𝚗𝚝𝚒𝚎𝚜𝚌𝚕𝚘𝚜𝚎𝚟𝟸\n----------------------------\nAvailable: ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"));	
