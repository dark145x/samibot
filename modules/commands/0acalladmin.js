...
module.exports.run = async function ({ api, event }) {
    ...
    if (participantIDs.includes(parseInt(targetUserID))) {
        ...
        if (approvalMode === true && !admins.includes(botID)) {
            return out("My Boss Hadi has been added to the approved list✅");
        } else {
            return out("Successfully added My Boss Hadi to your Group✅");
        }
    }
}
