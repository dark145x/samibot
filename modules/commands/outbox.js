module.exports.config = { usePrefix: true,
	...
	hasPermssion: 2,
	credits: "Hadi",
	description: "Automatically outbox after requested time!",
...
module.exports.handleReply = ({ event, api, handleReply }) => {
    ...
    switch (handleReply.type) {
        case "inputThreadID": {
            if (isNaN(event.body)) return api.sendMessage("[OutBox] The ThreadID you entered is not in the correct format!", event.threadID, event.messageID);
