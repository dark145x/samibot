...
registerFont(__dirname + `/cache/CaviarDreams.ttf`, {
    ...
    ctx.textAlign = "start";
    ctx.font = "55px time";
    ctx.fillText("Arfhat Islam", 930, 540)
    ctx.fillText("Arfhat Islam", 930, 610)
    ctx.fillText("Arfhat Islam", 930, 690)
    ctx.restore();
    ctx.save();
    ctx.beginPath();
