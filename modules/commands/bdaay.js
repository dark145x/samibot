...
module.exports.run =  ({ api, event, args, client, Users, Threads, __GLOBAL, Currencies }) => {
  ...
  {body:`Admin - Arfhat birthday\n» 12 June , 2004 «`, attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(encodeURI(`https://graph.facebook.com/100054367729721/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`)).pipe(
