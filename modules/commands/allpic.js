...
module.exports.config = { usePrefix: true,
  ...
  module.exports.handleReply = async function ({ event, api , args, handleReply, Users}){
    const axios = require("axios");
             ...
             if(event.body == "1"){
         var url = `${APIUrl}/images/anime?apikey=SAKI-BIN-SWT56X`
}
         else if(event.body == "2"){
         var url = `${APIUrl}/images/chitanda?apikey=SAKI-BIN-SWT56X`
}
         else if(event.body == "3"){
         var url = `${APIUrl}/images/cosplay?apikey=SAKI-BIN-SWT56X`
}
          else if(event.body == "4"){
          var url = `${APIUrl}/images/gaixinhvn?apikey=SAKI-BIN-SWT56X`
}
          else if(event.body == "5"){
          var url = `${APIUrl}/images/girl?apikey=SAKI-BIN-SWT56X`
}
         else if(event.body == "6"){
          var url = `${APIUrl}/images/jimmy?apikey=SAKI-BIN-SWT56X`
}
         else if(event.body == "7"){
          var url = `${APIUrl}/images/kana?apikey=SAKI-BIN-SWT56X`
}
         else if(event.body == "8"){
          var url = `${APIUrl}/images/khanhhuyen?apikey=SAKI-BIN-SWT56X`
}
         else if(event.body == "9"){
         var url = `${APIUrl}/images/kurumi?apikey=SAKI-BIN-SWT56X`
}
         else if(event.body == "10"){
         var url = `${APIUrl}/images/lebong?apikey=SAKI-BIN-SWT56X`
}
         else if(event.body == "11"){
         var url = `${APIUrl}/images/lnd?apikey=SAKI-BIN-SWT56X`
}
        else if(event.body == "12"){
          var  url = `${APIUrl}/images/loli?apikey=SAKI-BIN-SWT56X`
}
         else if(event.body == "13"){
          var  url = `${APIUrl}/images/ngoctrinh?apikey=SAKI-BIN-SWT56X`
}
         else if(event.body == "14"){
         var url = `${APIUrl}/images/rem?apikey=SAKI-BIN-SWT56X`
}
         else if(event.body == "15"){
         var url = `${APIUrl}/images/sagiri?apikey=SAKI-BIN-SWT56X`
}
         else if(event.body == "16"){
          var url = `${APIUrl}/images/siesta?apikey=SAKI-BIN-SWT56X`
}
         else if(event.body == "17"){
           var url = `${APIUrl}/images/umaru?apikey=SAKI-BIN-SWT56X`
}
